...
export class PeoplePortrayalComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    var mapBoxEchart = echarts.init(document.getElementById('peop'));
    var geoCoordMap = {
      //可以在地图上显示的城市的坐标信息
    ...
    var HFData = [
      // 数据中name的城市名称必须与geoCoordMap中城市名称一致, 不然关联不上，合肥到各地区的线路
      ...
      geo: {
        ...
        itemStyle: {
          ...
          emphasis: {
            ...
            borderColor: '#000',
            areaColor: '#1c325d',
            shadowColor: 'rgba(162, 251, 254 0.5)',
          },
        },
      },
      series: series,
